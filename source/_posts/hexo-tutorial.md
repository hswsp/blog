...
5. 前往 http://localhost:4000/ 查看成果。
   ![在这里插入图片描述](https://img-blog.csdnimg.cn/20201028113842979.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzcxMzEwNQ==,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201028115741150.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzcxMzEwNQ==,size_16,color_FFFFFF,t_70#pic_center)
...
3. 进入js.org官方仓库：https://github.com/js-org/js.org 点击右上角的fork，你会发现这个仓库被fork到自己名下了。
   ...
   ![在这里插入图片描述](https://img-blog.csdnimg.cn/20201028120351288.png#pic_center)
...
6. 审核通过你会收到下图所示邮件：
   ![在这里插入图片描述](https://img-blog.csdnimg.cn/20201028121942238.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzcxMzEwNQ==,size_16,color_FFFFFF,t_70#pic_center)
7. 通过后不要着急，人家只是通过了你的申请，但是还没给你解析呢，解析后会收到下图所示邮件：
   ![在这里插入图片描述](https://img-blog.csdnimg.cn/20201028122330166.png#pic_center)
8. 现在就可以用你申请的域名访问你的博客了，我的博客:
   ![在这里插入图片描述](https://img-blog.csdnimg.cn/20201028123209663.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzcxMzEwNQ==,size_16,color_FFFFFF,t_70#pic_center)
...
![image](https:////upload-images.jianshu.io/upload_images/5615781-03cc818f75427083?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)
...
![image](https://upload-images.jianshu.io/upload_images/5615781-5de7693a31d0b091?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)
...
![img](https:////upload-images.jianshu.io/upload_images/2787497-03fa5a9ab8194014.jpg?imageMogr2/auto-orient/strip|imageView2/2/w/731/format/webp)
...
1. 创建七牛云存储空间
   ...
   ![image-20220330002946984](https://img-blog.csdnimg.cn/img_convert/6c4fcf368c805a142c67076eef32a3e1.png#pic_center)
...
![image-20220330003123314](https://img-blog.csdnimg.cn/img_convert/0747689e1cdc2205b238140aa93e8416.png#pic_center)

然后添加一个二级域名，这个完了先不要关，等下还要改

![image-20220330003356467](https://img-blog.csdnimg.cn/img_convert/8de4e1820d58da359b6b48fada2b63ce.png#pic_center)

3. 绑定二级域名

进入[七牛云域名绑定页面](https://portal.qiniu.com/cdn/domain)，点击添加域名，然后下图只需要把刚刚配置的域名写上，然后其余默认就行，点击创建

![image-20220330003544871](https://img-blog.csdnimg.cn/img_convert/66cd88be1aa780a8fda147c1faea7b51.png#pic_center)

这里由于是github.io，没有进行备案，只能申请海外服务器。同时在绑定域名后会让你进行TXT记录验证。输入它给的主机名和主机值新增一条域名解析即可。

然后回到上一个页面，跟着下图操作

![image-20220330003733736](https://img-blog.csdnimg.cn/img_convert/61f324a844768635a01bb06b50866447.png#pic_center)

![image-20220330003847097](https://img-blog.csdnimg.cn/img_convert/4699773498babd6a54a6016f80e908e1.png#pic_center)
...
![image-20220330004201058](https://img-blog.csdnimg.cn/img_convert/842bafe5e6389bee18752ec69c1a7930.png#pic_center)
...
![8b5962587655cdfbe59cb805083481abb2e.jpg](https://oscimg.oschina.net/oscnet/8b5962587655cdfbe59cb805083481abb2e.jpg)

**核对信息，确认支付即可**

![ba24df3b5b7785726ee3a084c73ebfb7929.jpg](https://oscimg.oschina.net/oscnet/ba24df3b5b7785726ee3a084c73ebfb7929.jpg)

**补全相关信息**

![4f66317234eb658ca59865dbdb9e5fc2258.jpg](https://oscimg.oschina.net/oscnet/4f66317234eb658ca59865dbdb9e5fc2258.jpg)
...
[![image-20210110205814315](https://aigisss.com/blog/posts/798ba833/image-20210110205814315.png)](https://aigisss.com/blog/posts/798ba833/image-20210110205814315.png)
...
[![image-20210110210639345](https://aigisss.com/blog/posts/798ba833/image-20210110210639345.png)](https://aigisss.com/blog/posts/798ba833/image-20210110210639345.png)
